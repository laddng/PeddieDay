...
class ScoresControllerTest < ActionController::TestCase
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post :create, score: { active: @score.active, blairScore: @score.blairScore, peddieScore: @score.peddieScore, team: @score.team }
    end
  ...
  test "should update score" do
    patch :update, id: @score, score: { active: @score.active, blairScore: @score.blairScore, peddieScore: @score.peddieScore, team: @score.team }
    assert_redirected_to score_path(assigns(:score))
  end
